...
export class Credito extends Entity {
  @property({
    ...
    scale: 0,
    id: 1,
    mssql: {columnName: 'id_credito', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'NO'},
  })
  idCredito: number;
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mssql: {columnName: 'id_cliente', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'NO'},
  })
  idCliente: number;
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mssql: {columnName: 'ventaid_', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'NO'},
  })
  ventaid: number;
