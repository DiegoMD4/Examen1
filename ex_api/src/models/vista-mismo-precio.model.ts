...
@model({
  settings: {idInjection: false, mssql: {schema: 'dbo', table: 'VistaMismoPrecio'}}
})
export class VistaMismoPrecio extends Entity {
  @property({
    type: 'string',
    required: true,
    length: 100,
  ...
  constructor(data?: Partial<VistaMismoPrecio>) {
    super(data);
  }
}

export interface VistaMismoPrecioRelations {
  // describe navigational properties here
}

export type VistaMismoPrecioWithRelations = VistaMismoPrecio & VistaMismoPrecioRelations;
